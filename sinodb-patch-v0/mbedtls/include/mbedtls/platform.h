...
#if defined(__IBMC__)
#define MBEDTLS_PLATFORM_STD_CALLOC   aix_calloc /**< Default allocator to use */
static inline void *aix_calloc(size_t nmemb, size_t size)
{
	return calloc(nmemb, size ?size :1);
}
#else
